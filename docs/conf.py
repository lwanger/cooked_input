...
# -*- coding: utf-8 -*-
#
# cooked_input documentation build configuration file, created by
...
# Sphinx 5 deprecated None here; it must be a language code.
language = 'en'
...
htmlhelp_basename = 'cooked_inputdoc'
...
latex_documents = [
    (master_doc, 'cooked_input.tex', 'cooked\\_input Documentation',
     'Len Wanger', 'manual'),
]
...
man_pages = [
    (master_doc, 'cooked_input', 'cooked_input Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cooked_input', 'cooked_input Documentation',
     author, 'cooked_input', 'One line description of project.',
     'Miscellaneous'),
]
