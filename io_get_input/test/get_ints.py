...
if __name__ == '__main__':
    ...
    # get any integer
    print(get_input(convertor=IntConvertor(), prompt='Enter an integer', default=5))

    # get a positive integer
    print(get_input(convertor=IntConvertor(), validators=[pos_int_validator], prompt='Enter a positive integer'))

    # get an integer between 0 and ten
    print(get_input(convertor=IntConvertor(), validators=[zero_to_ten_validator], prompt='Enter an integer between 0 and 10'))

    # get zero - silly but makes more sense with the in any or not in validators
    print(get_input(convertor=IntConvertor(), validators=[exactly_0_validator], prompt='Enter 0'))

    # get zero or 5
    print(get_input(convertor=IntConvertor(), validators=[in_0_or_5_validator], prompt='Enter 0 or 5'))

    # get a non-zero integer
    print(get_input(convertor=IntConvertor(), validators=[not_0_validator], prompt='Enter a non-zero integer'))

    # get a non-zero integer between 0 and 10
    print(get_input(convertor=IntConvertor(), validators=[zero_to_ten_validator, not_0_validator], prompt='Enter a non-zero integer between 0 and 10'))

    # enter an integer besides zero or 5
    print(get_input(convertor=IntConvertor(), validators=[not_0_or_5_validator], prompt='Enter and integer besides 0 or 5'))
