...
* A single string given to `AnyOfValidator` or `NoneOfValidator` is now one choice rather than
  being iterated one character at a time.

See [CHANGELOG.rst](https://github.com/lwanger/cooked_input/blob/master/CHANGELOG.rst) for the
