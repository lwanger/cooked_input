...
class TestGetList(object):
    ...
    def test_list_of_str(self, fake_input):
    ...
    def test_list_of_int(self, fake_input):
        input_str = '1,2,3\n'
    ...
    def test_list_of_yes_no(self, fake_input):
    ...
    def test_list_of_choices(self, fake_input):
        input_str = 'r g b\nr g bl brown'
    ...
    def test_list_of_lists(self, fake_input):
    ...
    def test_get_input_list_2(self, fake_input):
        input_str = u"""
            foo, bar, blat
            1-2-3
            """
    ...
    def test_get_input_list_3(self, fake_input):
        input_str = u"""
            foo, bar
            -1,2,3
            """
