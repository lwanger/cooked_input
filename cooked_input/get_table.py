...
Holds the machinery: :class:`Table` and the :class:`TableItem` and :class:`TableStyle` it is
built from, plus the row actions and pagination commands they use. The convenience functions
that wrap all this -- ``create_table``, ``get_menu`` and the rest -- live in
``table_convenience.py``.
